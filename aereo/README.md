...
incluye las placas “Mirador: afinar lo que vemos” integradas en esta publicación;
las demás postas también conservan sus materiales dentro de `assets/`.
...
Toda la interfaz usa la familia Faustina distribuida localmente en varios pesos,
